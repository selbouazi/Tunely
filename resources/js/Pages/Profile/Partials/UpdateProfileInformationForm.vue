...
const previewUrl = computed(() => form.foto instanceof File ? URL.createObjectURL(form.foto) : (user.foto || '/img/profiles/default.webp'));
        ...
        >
            <div class="flex items-center gap-6 mb-4">
                <div class="flex-shrink-0">
                    <img :src="previewUrl" alt="Foto de perfil" class="w-20 h-20 rounded-full object-cover border border-gray-200">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Foto de perfil</label>
                    <input type="file" accept="image/jpeg,image/png,image/gif,image/webp" @change="onFileSelect" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-medium file:bg-[#E87F24] file:text-white hover:file:bg-[#FFC81E]">
            ...
            <template v-if="!isAdmin">
                <h3 class="font-medium text-[#1a1a1a] pt-2 border-b border-[#1a1a1a]/10 pb-2">Dirección de envío</h3>
                <div class="grid md:grid-cols-2 gap-4">
                ...
                <h3 class="font-medium text-[#1a1a1a] pt-2 border-b border-[#1a1a1a]/10 pb-2">Dirección de facturación</h3>
                <div class="grid md:grid-cols-2 gap-4">
                    <div class="md:col-span-2">
                ...
                <h3 class="font-medium text-[#1a1a1a] pt-2 border-b border-[#1a1a1a]/10 pb-2">Preferencias</h3>
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
